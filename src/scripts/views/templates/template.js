...
const createRestaurantItemTemplate = (restaurant) => `
  <article class="resto-item">
    <img class="resto-item-thumbnail" src="${CONFIG.BASE_IMAGE_URL}${restaurant.pictureId}" alt="${restaurant.name}" crossorigin = "anonymous" />
...
const createRestaurantDetailTemplate = (restaurant) => `   
  <div class="detail">
    ...
    <img class="detail-item-thumbnail" src="${CONFIG.BASE_IMAGE_URL}${restaurant.pictureId}" alt="${restaurant.name}" crossorigin = "anonymous"/>
